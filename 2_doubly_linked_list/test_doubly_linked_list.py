import unittest
from doubly_linked_list import Node, LinkedList2
...
class TestDoublyLinkedListDelete(unittest.TestCase):
    ...
    def test_delete_at_oneitem(self):
        self.linked_list = create_DoublyLinkedList([1])
        self.linked_list.delete(1)
    ...
    def test_delete_all_sequently(self):
        self.linked_list = create_DoublyLinkedList([1,1,1,2,4])
    ...
    def test_delete_all_nonsequently(self):
        self.linked_list = create_DoublyLinkedList([1,2,1,4,1])
        self.linked_list.delete(1, all=True)
        
        self.assertEqual(to_native_list(self.linked_list), [2,4])
    
    def test_delete_all_same_items(self):
        self.linked_list = create_DoublyLinkedList([1,1,1,1,1])
        self.linked_list.delete(1, all=True)
    ...
    def test_delete_all_same_items_except_one(self):
        self.linked_list = create_DoublyLinkedList([1,1,2,1,1,1])
        self.linked_list.delete(1, all=True)
